...
function AddForm(props) {
    ...
    const URL_ADD_EVENT = "/event/addEvent";
    ...
    const handleSubmit = async (e) => {
        ...
        if (files) {
            ...
            await axios.post(URL_UPLOAD_IMAGES, data, { Headers: { 'Content-Type': 'multipart/form-dat' }, withCredentials: true }).then((res) => {
                axios.post(URL_ADD_EVENT, {
    ...
    return (
        <>
            <Button variant='outlined' color='info' onClick={handleClickOpen}> Add Event</Button>
            <Dialog
                open={open}
                onClose={handleColse}
                fullWidth={fullWidth}
